...
},
{
    ...
    options : [ 
        ...
        {optionText:'Stupefy', gryffindor:2, ravenclaw:3, slytherin:1, hufflepuff:1},
        {optionText:'Avada Kedvara', gryffindor:0, ravenclaw:1, slytherin:4, hufflepuff:0}
...
{
    questionText: 'What do you believe is your strongest trait?',
    options : [ 
...
},
{
    ...
    options : [ 
        ...
        {optionText: 'Hagrid', gryffindor:3, ravenclaw:1, slytherin:0, hufflepuff:2},
        {optionText: 'Pomona Sprout', gryffindor:0, ravenclaw: 2, slytherin:0, hufflepuff:4}

    ],
},
{
    questionText: 'Which item would you choose to have forever?',
    options : [ 
        {optionText: 'ElderWand', gryffindor:1, ravenclaw: 2, slytherin:3, hufflepuff:0},
        {optionText: 'Cloak', gryffindor:2, ravenclaw: 1, slytherin:1, hufflepuff:3},
        {optionText: 'Stone', gryffindor:0, ravenclaw:2, slytherin:1, hufflepuff:1},
        {optionText: 'Time-Turner', gryffindor:2, ravenclaw: 2, slytherin:3, hufflepuff:1}

    ],
},
{
    questionText: 'What core would you choose for your wand?',
    options : [ 
        {optionText: 'Unicorn-Hair', gryffindor:2, ravenclaw: 1, slytherin:1, hufflepuff:3},
        {optionText: 'Phoenix', gryffindor:1, ravenclaw: 2, slytherin:2, hufflepuff:1},
        {optionText: 'Dragon', gryffindor:1, ravenclaw:3, slytherin:1, hufflepuff:1},
        {optionText: 'Basilisk', gryffindor:1, ravenclaw: 1, slytherin:3, hufflepuff:0}
...
{
    questionText: 'If you could take a luck potion to win a quidditch match, would you?',
    options: [
